...
class Survey2Form(Form):
    ...
    department = fields.TextField('If you are a student in what department are you majoring?', validators=[Required()])
...
class Survey3Form(Form):
    ...
    specify1 = fields.TextField('please specify', validators=[Required()])
